...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 344.0, 168.0, 20.0 ],
					"text" : "envelope follow to find silence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 420.0, 150.0, 20.0 ],
					"text" : "mute"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 318.0, 329.0, 46.0, 22.0 ],
					"text" : "atodb~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 318.0, 296.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 414.0, 35.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.0, 382.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 318.0, 353.0, 47.0, 22.0 ],
					"text" : "<~ -60."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.0, 72.0, 150.0, 20.0 ],
					"text" : "max amp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 103.0, 78.0, 35.0, 22.0 ],
					"text" : "sah~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 173.0, 36.0, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 151.0, 64.0, 33.0 ],
					"text" : "get amplitude."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 152.0, 64.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 103.0, 36.0, 71.0, 22.0 ],
					"text" : "fftin~ 1 nofft"
				}
